...
export const EVENT_ACTIONS = {
	...
	UNLISTEN_ACK: { ACK: true, TEXT: 'UL', BYTE: 0x09 },
...
export const RECORD_ACTIONS = {
	...
	SUBSCRIPTION_HAS_PROVIDER: { TEXT: 'HP', BYTE: 0x36 },
	SUBSCRIPTION_FOR_PATTERN_FOUND: { TEXT: 'SP', BYTE: 0x37 },
	SUBSCRIPTION_FOR_PATTERN_REMOVED: { TEXT: 'SR', BYTE: 0x38 },
...
export const PRESENCE_ACTIONS = {
	...
	SUBSCRIBE_ACK: { ACK: true, TEXT: 'S', BYTE: 0x08 },
	UNSUBSCRIBE: { TEXT: 'US', BYTE: 0x09 },
	UNSUBSCRIBE_ACK: { ACK: true, TEXT: 'US', BYTE: 0x10 }
}
