...
export const PRESENCE_ACTIONS = {
  ...
  QUERY: { TEXT: 'Q', BYTE: UA.QUERY, PAYLOAD_ENCODING: PAYLOAD_ENCODING.JSON },
  ...
  SUBSCRIBE: { TEXT: 'S', BYTE: UA.SUBSCRIBE, PAYLOAD_ENCODING: PAYLOAD_ENCODING.JSON },
  SUBSCRIBE_ACK: { BYTE: UA.SUBSCRIBE_ACK },
  UNSUBSCRIBE: { TEXT: 'US', BYTE: UA.UNSUBSCRIBE, PAYLOAD_ENCODING: PAYLOAD_ENCODING.JSON },
