...
export const CONNECTION_ACTIONS = {
	...
	REJECTION: { TEXT: 'REJ', BYTE: CA.REJECTION },
...
export const RECORD_ACTIONS = {
	...
	SUBSCRIBE: { BYTE: RA.SUBSCRIBE },
	SUBSCRIBE_ACK: { ACK: true, BYTE: RA.SUBSCRIBE_ACK },
...
export const RPC_ACTIONS = {
	...
	REQUEST_ERROR: { TEXT: 'E', BYTE: PA.REQUEST_ERROR },
	...
	MULTIPLE_SUBSCRIPTIONS: { BYTE: PA.MULTIPLE_SUBSCRIPTIONS },
	NOT_SUBSCRIBED: { BYTE: PA.NOT_SUBSCRIBED }
}

export const PRESENCE_ACTIONS = {
	ERROR: { TEXT: 'E', BYTE: UA.ERROR },
	QUERY_ALL: { BYTE: UA.QUERY_ALL },
	QUERY_ALL_RESPONSE: { BYTE: UA.QUERY_ALL_RESPONSE },
	QUERY: { TEXT: 'Q', BYTE: UA.QUERY },
	QUERY_RESPONSE: { BYTE: UA.QUERY_RESPONSE },
